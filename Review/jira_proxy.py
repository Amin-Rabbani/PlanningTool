#!/usr/bin/env python3
"""Local static server + Jira CORS proxy for review.html."""
...
def main():
    parser = argparse.ArgumentParser(description="Serve review.html with Jira CORS proxy")
    ...
    print(f"Review app:   http://{args.host}:{args.port}/review.html")
